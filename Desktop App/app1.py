...
from PyQt5.QtWidgets import QLineEdit,QFileDialog,QMainWindow,QApplication, QHBoxLayout, QVBoxLayout, QApplication, QPushButton
...
class Ui(QMainWindow):
    ...
    def start_video(self):
        ...
        videoWidget.setFixedHeight(200)
