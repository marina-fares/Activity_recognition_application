...
def detect_activities(model_logits,model_predictions,rgb_saver,rgb_input,video_path,video_frames):
  #restore the model weights from the checkpoints
  with tf.Session() as sess:
    eval_type = FLAGS.eval_type
    imagenet_pretrained = FLAGS.imagenet_pretrained
...
def activity_recogniton(video_path,video_frames):
  model_logits,model_predictions,rgb_saver,rgb_input = getModel()
  detect_activities(model_logits,model_predictions,rgb_saver,rgb_input,video_path,video_frames)
